    ...
    function onepress_site_logo(){
        ...
        if ( ! $hide_sitetile ) {
            ...
            if ( is_front_page() && !is_home() ) {
				...
				$html .= '<h1 class="site-title"><a class="site-text-logo" href="' . esc_url(home_url('/')) . '" rel="home"> sostenibl.<span class="color-logo">es</span> </a></h1>';
            } else {
            ...
            <div class="container">
                ...
                <div class="header-right-wrapper">
                    ...
                    <nav id="site-navigation" class="main-navigation" role="navigation">
						...
						<li id="menu-item-1206" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-1206">																
							
							<a href=""><span class="recuadro-color">únete</span></a>
